<template>
  <div id="app">
    <div id="input1">
      ...
      <el-input v-model="input1" placeholder="设备编号"></el-input>
    ...
    <div id="input2">
      <div id="image3">
        <el-image :src="imagePath2" style="width: 40px; height: 220px"></el-image>
      </div>
<!--      <p id="text1">设备示意图</p>-->
<!--      <p id="text2">设备信息列表</p>-->
...
export default {
  ...
  data() {
    return {
      ...
      input8: '',
      input9: '',
      imagePath2: require('@/assets/management/sbxx.png'), // 员工照片路径
      form: {
        imageUrl: '',//放大后展示的图片路径
      },
      showImg: true, //默认展示
